...
exports.getSellerDashboardStats = (0, asyncHandler_1.default)(async (req, res) => {
    ...
    if (user.role !== "admin")
        throw new ApiError_1.ApiError(403, "Only admins can view dashboard stats");
...
exports.getSellerRecentOrders = (0, asyncHandler_1.default)(async (req, res) => {
    ...
    if (!user)
        throw new ApiError_1.ApiError(404, "User not found");
    if (user.role !== "admin")
        throw new ApiError_1.ApiError(403, "Only admins can view recent orders");
...
exports.getSellerTopProducts = (0, asyncHandler_1.default)(async (req, res) => {
    ...
    if (!user)
        throw new ApiError_1.ApiError(404, "User not found");
    if (user.role !== "admin")
        throw new ApiError_1.ApiError(403, "Only admins can view top products");
