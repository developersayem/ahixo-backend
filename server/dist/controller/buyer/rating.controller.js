...
exports.toggleRating = void 0;
const product_model_1 = require("../../models/product.model");
const ApiError_1 = require("../../utils/ApiError");
const asyncHandler_1 = __importDefault(require("../../utils/asyncHandler"));
// Toggle rating
exports.toggleRating = (0, asyncHandler_1.default)(async (req, res) => {
    const userId = req.user?._id;
    const { productId } = req.params;
    const { rating } = req.body;
    if (rating !== undefined && (rating < 0 || rating > 5)) {
        throw new ApiError_1.ApiError(400, "Rating must be between 0 and 5");
    }
    ...
    if (existingRatingIndex !== undefined && existingRatingIndex >= 0) {
        ...
        if (rating === undefined) {
            throw new ApiError_1.ApiError(400, "Rating value is required to add rating");
        }
